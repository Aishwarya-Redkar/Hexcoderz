...
$result = mysqli_query($conn,"SELECT * FROM test_prescription");
?>
<html>
<head>
...
<tr class="<?php if(isset($classname)) echo $classname;?>">
	<td><input type="checkbox" name="test_prescription[]" value="<?php echo $row["id"]; ?>" ></td>
	<td><?php echo $row["id"]; ?></td>
	<td><?php echo $row["date"]; ?></td>
	<td><?php echo $row["patient"]; ?></td>
	<td><?php echo $row["nxt_visit"]; ?></td>
