...
$result=mysqli_query($conn,"UPDATE states set name='" . $_POST["name"][$i] . "', country_id='" . $_POST["country_id"][$i] . "' WHERE state_id='" . $_POST["state_id"][$i] . "'");
}
...
$result = mysqli_query($conn,"SELECT * FROM states WHERE state_id='" . $_POST["states"][$i] . "'");
