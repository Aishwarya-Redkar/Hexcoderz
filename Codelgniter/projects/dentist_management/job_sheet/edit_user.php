...
$result=mysqli_query($conn,"UPDATE job_sheet set user_id='" . $_POST["user_id"][$i] . "', doc_id='" . $_POST["doc_id"][$i] . "', job_desc='" . $_POST["job_desc"][$i] . "', appo_date='" . $_POST["appo_date"][$i] . "',appo_time='" . $_POST["appo_time"][$i] . "', service_name='" . $_POST["service_name"][$i] . "' WHERE id='" . $_POST["id"][$i] . "'");
}
...
$result = mysqli_query($conn,"SELECT * FROM job_sheet WHERE id='" . $_POST["job_sheet"][$i] . "'");
