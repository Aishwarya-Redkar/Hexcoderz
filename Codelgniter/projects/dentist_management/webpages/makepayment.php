...
<head>
    ...
    <title>Coproppeled | Make Payment</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>View Pending Payments</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>All your Pending Payments</h5>
                    ...
                    <tr class="gradeA">
                        ...
                        <td class="">
                        <button class="btn btn-primary btn-block">Make Payment<i class="fa fa-arrow-right"></i></button>
                        </td>
