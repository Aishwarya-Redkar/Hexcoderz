...
<body class="">
   ...
   <?php include 'nav.php';?>
        ...
        <div class="navbar-header">
            ...
            <form role="search" class="navbar-form-custom" action="http://webapplayers.com/inspinia_admin-v2.5/search_results.php">
