        ...
        <div class="row">
                <div class="col-lg-4">
                        ...
                        <div class="widget-text-box">
                            <h4 class="media-heading">AshAlexsius</h4>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                            <div class="text-right">
                                <a class="btn btn-xs btn-primary"><i class="fa fa-pencil-square-o"></i>Edit Info</a>
                            </div>
                        </div>
                </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="widget red-bg p-lg text-center">
                        <div class="m-b-md">
                            ...
                            <small>Total number of Appointments.</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                <div class="widget yellow-bg p-lg text-center">
                    ...
                    <div class="widget lazur-bg p-lg text-center">
                        <div class="m-b-md">
                            ...
                            <h1 class="m-xs">Rs. 10000</h1>
                            <h3 class="font-bold no-margins">
                                Total Expence
                            </h3>
                            <small>Amount payed till date</small>
                        </div>
                    </div>
                    </div>
            </div>
