...
<head>
    ...
    <title>Coproppeled | Medical History</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>All your Medical History Documents</h5>
                    ...
                    <tr class="gradeA">
                        ...
                        <td>27-02-2016</td>
                        <td>10:45 AM</td>
                        <td class="center">Something about the document</td>
                        <td class="">
                        ...
                        <td class="">
                        <button class="btn btn-primary btn-block">Delete <i class="fa fa-arrow-down"></i></button>
                        </td>
