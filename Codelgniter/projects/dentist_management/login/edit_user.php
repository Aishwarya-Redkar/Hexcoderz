...
$usersCount = count($_POST["email"]);
for($i=0;$i<$usersCount;$i++) {
$result=mysqli_query($conn,"UPDATE login set email='" . $_POST["email"][$i] . "', password='" . $_POST["password"][$i] . "' WHERE id='" . $_POST["id"][$i] . "'");
}
...
$result = mysqli_query($conn,"SELECT * FROM login WHERE id='" . $_POST["login"][$i] . "'");
